...
MeasurementManager::MeasurementManager(ManagerParams params, std::unique_ptr<ring::SensorRing> sensor_ring) : _params(params) {
  init(std::move(sensor_ring));
}

MeasurementManager::~MeasurementManager() { stopMeasuring(); }

void MeasurementManager::init(std::unique_ptr<ring::SensorRing> sensor_ring) {
...
void MeasurementManager::enableTofMeasurement(bool state) { _tof_enabled = state; }

void MeasurementManager::enableThermalMeasurement(bool state) { _thermal_enabled = state; }

ManagerParams MeasurementManager::getParams() const { return _params; }
...
bool MeasurementManager::stopThermalCalibration() { return _sensor_ring->stopThermalCalibration(); }

bool MeasurementManager::startThermalCalibration(std::size_t window) { return _sensor_ring->startThermalCalibration(window); }
...
WorkerState MeasurementManager::getWorkerState() const { return _manager_state; }
...
std::unique_ptr<MeasurementManager> MeasurementManager::buildManager(ManagerParams params)
{
  ...
  return std::make_unique<MeasurementManager>(params, std::move(ring));
}
